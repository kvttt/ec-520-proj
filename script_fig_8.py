"""
File Name: script_fig_8.py
Author: Kaibo
Function: Generates the Urban100 AWGN sample comparison figure and subplot NPZ files.
Reference: None.
"""
...
fn = "data/Urban100/img_005_SRF_4_HR.png"
...
save_panel_npz_outputs(
    panels=panels,
    u_clean=u_clean,
    output_dir=Path("figures/fig8/npz"),
    image_mode="rgb",
    prefix="fig8",
