...
axes[1, 1].set_title(f"MSE: {mse_gaussian:.4f}, PSNR: {psnr_gaussian:.2f} dB,\nSSIM: {ssim_gaussian:.4f}, Perceptual: {perceptual_gaussian:.4f}")
...
axes[1, 2].set_title(f"MSE: {mse_median:.4f}, PSNR: {psnr_median:.2f} dB,\nSSIM: {ssim_median:.4f}, Perceptual: {perceptual_median:.4f}")
...
axes[1, 3].set_title(f"MSE: {mse_wiener:.4f}, PSNR: {psnr_wiener:.2f} dB,\nSSIM: {ssim_wiener:.4f}, Perceptual: {perceptual_wiener:.4f}")
...
axes[3, 0].set_title(f"MSE: {mse_noisy:.4f}, PSNR: {psnr_noisy:.2f} dB,\nSSIM: {ssim_noisy:.4f}, Perceptual: {perceptual_noisy:.4f}")
...
axes[3, 1].set_title(f"MSE: {mse_bayesian_markov:.4f}, PSNR: {psnr_bayesian_markov:.2f} dB,\nSSIM: {ssim_bayesian_markov:.4f}, Perceptual: {perceptual_bayesian_markov:.4f}")
...
axes[3, 2].set_title(f"MSE: {mse_nlm:.4f}, PSNR: {psnr_nlm:.2f} dB,\nSSIM: {ssim_nlm:.4f}, Perceptual: {perceptual_nlm:.4f}")
axes[2, 3].imshow(u_bf, cmap='gray', vmin=0, vmax=1)
axes[2, 3].set_title("Bilateral filtering")
